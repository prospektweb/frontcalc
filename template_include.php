...
if (!function_exists('frontcalc_should_show_catalog_button')) {
    function frontcalc_should_show_catalog_button(): bool
    {
        return class_exists('\Bitrix\Main\Config\Option')
            && \Bitrix\Main\Config\Option::get('prospektweb.frontcalc', 'SHOW_CATALOG_BUTTON', 'N') === 'Y';
    }
}
...
if (!function_exists('frontcalc_render_catalog_button')) {
    ...
    {
        if (!frontcalc_should_show_catalog_button()) {
            return '';
        }

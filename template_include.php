...
.frontcalc-table-body{display:flex;flex-direction:column;gap:8px;max-height:380px;overflow:auto;}
.frontcalc-table-row{display:grid;grid-template-columns:1.1fr 1fr 1fr;gap:8px;}
.frontcalc-cell{border:1px solid #d9dee7;border-radius:10px;background:#fff;min-height:64px;padding:8px 10px;display:flex;flex-direction:column;align-items:flex-start;justify-content:center;cursor:pointer;}
.frontcalc-cell-main{font-size:20px;line-height:1.1;color:#212a3f;}
.frontcalc-cell-sub{font-size:13px;color:#8b93a6;margin-top:4px;}

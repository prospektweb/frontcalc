function initAsproPopupModalConditionsControl(params)
{
	var data = JSON.parse(params.data);
	if (data)
	{
		window['aspro_popup_modalconditions_conditions_' + params.propertyID] = new AsproPopupModalConditionsControl(data, params);
	}
}

function AsproPopupModalConditionsControl(data, params)
{
...
AsproPopupModalConditionsControl.prototype =
{
	getPath: function()
	{
